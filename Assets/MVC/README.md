...
**Model–View–Controller 구조를 Unity에서 직접 구현한 예제**
...
> HP Bar와 Damage / Heal 버튼을 이용해  
> Model의 값이 변경되고, Controller를 거쳐 View가 갱신되는 과정을 테스트할 수 있습니다.
...
MVC 구조는  
Model(게임 로직)과 View(UI)가 분리되어, 서로가 서로를 쉽게 갈아끼울 수 있다는 것은 장점이었지만,  
